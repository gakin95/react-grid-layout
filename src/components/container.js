    ...
    <div className={classes.root}>
      ...
      >
        ...
        <div>
          ...
          >
            {layout.map((item,i) => <div key={item.i} style={{ border: "1px solid", backgroundColor:"#212121", color:'white' }}>
            {item.i}
            </div>)}
          </GridLayout>
        </div>
      ...
      <main className={classes.content}>
        ...
        <GridLayout
          ...
          >
            {mainLayout.map((item,i) => <div key={item.i} className={classes.interactiveItems}>
            {item.i}
            </div>)}
          </GridLayout>
        </Paper>
